...
pub enum AgentEvent {
    ...
    #[allow(dead_code)] // reserved: explicit repair entry for future loop wiring
    BeginRepair,
...
impl AgentMachine {
    ...
    #[allow(dead_code)] // optional seed path; default heuristics cover current loop
    ...
    #[allow(dead_code)] // inspection API for benchmark / debugging harnesses
...
mod tests {
    ...
    impl FakeProvider {
        ...
        fn next(&mut self) -> FakeReply {
            self.script.pop_front().unwrap_or(FakeReply::Final)
        }
    }
    ...
    impl FakeTools {
        ...
        #[allow(dead_code)] // used by permission-denial benchmark path
        fn deny_writes() -> Self {
            Self {
                deny_write: true,
                ..Self::ok()
