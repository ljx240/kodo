...
impl ContextManager {
    ...
    #[allow(dead_code)] // inspection API for benchmarks / tooling
    ...
    #[allow(dead_code)] // used by tests and future packing callers
    ...
    #[allow(dead_code)] // exported helper; exercised by benchmark harness
